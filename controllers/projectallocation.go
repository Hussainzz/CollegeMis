...
type ProjectSAllController struct{
	beego.Controller
}
...
// @Success 200 {object} models.ProjectAllocation
// @Failure 403
// @router / [get]
func (c *ProjectSAllController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllProjectAllocation(query, fields, sortby, order, offset, limit)
	if err != nil {
...
// @Param	Paid		path 	string	true		"The Paid you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 Paid is empty
// @router /:Paid [delete]
func (this *ProjectDeleteController) Delete(){
	o := orm.NewOrm()
	Paid, _ := strconv.Atoi(this.Ctx.Input.Param(":Paid"))
			ProjectD := &models.ProjectAllocation{Paid:Paid}
			
			
			if num, err := o.Delete(ProjectD); err == nil {
				fmt.Println(num)
				fmt.Println(num)
