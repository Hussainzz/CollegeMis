...
// @Failure 403
// @router / [get]
func (c *AllocationAllController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllAllocation(query, fields, sortby, order, offset, limit)
	if err != nil {
...
type DeleteAllocationController struct{
	beego.Controller
}

// @Title Delete
// @Description delete the allocation
// @Param	Aaid		path 	string	true		"The Nid you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 Aaid is empty
// @router /:Aaid [delete]
func (this *DeleteAllocationController) Delete(){
	o := orm.NewOrm()
	Aaid, _ := strconv.Atoi(this.Ctx.Input.Param(":Aaid"))
			AllocationD := &models.Allocation{Aaid:Aaid}
			
			
			if num, err := o.Delete(AllocationD); err == nil {
				fmt.Println(num)
				fmt.Println(num)
